...
from services.database import save_conversation, get_or_create_user, get_user_by_phone
...
from services.payment_service import initiate_escrow_payment, confirm_delivery
from services.translation import detect_language, translate_to_english, translate_from_english, text_to_speech
from services.notification import send_whatsapp_message, send_whatsapp_voice
...
async def process_incoming_message(phone: str, msg_type: str, message: dict, msg_id: str):
    ...
    try:
        ...
        if user.get("user_type") == "farmer" and detected_lang != "en":
            ...
            await send_whatsapp_voice(phone, audio_url)
        else:
...
async def handle_check_status(entities: dict, user: dict, content: dict, lang: str):
    ...
    from services.database import get_active_transactions
