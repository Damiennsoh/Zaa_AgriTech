...
```bash
psql -d zaa -f ../part1_database/schema.sql
```
...
4. Set start command: `uvicorn part2_backend.main:app --host 0.0.0.0 --port $PORT`
...
### Step 2: Set API URL
```bash
export NEXT_PUBLIC_API_URL=https://your-render-url.onrender.com/api/v1/marketplace
```
